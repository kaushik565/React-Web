export default function ContextSlide() {
  const problems = [
    { icon: '🔍', title: 'Manual Inspection', desc: 'Human error prone, inconsistent validation', color: 'red' },
    { icon: '⚠️', title: 'No Cross-Line Check', desc: 'Critical mix-up risk between batches', color: 'orange' },
    { icon: '📊', title: 'No Range Validation', desc: 'Out-of-batch cartridges slip through', color: 'amber' },
    { icon: '🔄', title: 'No Duplicate Detection', desc: 'Data integrity compromised', color: 'yellow' }
  ];
